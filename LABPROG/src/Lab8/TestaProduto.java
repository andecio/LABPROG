...
public class TestaProduto {
	...
	private final String NOME_DO_PRODUTO = "Cachaça Caranguejo";
	private EstrategiaSimples estrategiaSimples = new EstrategiaSimples();
	private EstrategiaSazonal estrategiaSazonal = new EstrategiaSazonal();
	private final String COMENTARIO1 = "Amei, achei digno de Oscar!";
	private final String COMENTARIO2 = "Interessante e inovador. Bastante útil no dia a dia.";
	private final String COMENTARIO3 = "Nada impressionante.";
	private final String COMENTARIO4 = "Muito ruim. RETIREM ESSE PRODUTO AGORA DAS PRATELEIRAS.";
	...
	public void criaObjetos() throws Exception{
		produtoTeste = new Produto(NOME_DO_PRODUTO);
		setNotaProduto(2);
	...
	public void testaAdicionaOpinioes(){
		...
		Assert.assertEquals("Cachaça Caranguejo", produtoTeste.getNome());
	}
	...
	public void testaNotasIguais() throws Exception{
		...
		Assert.assertEquals("Comentário com avaliação mais positiva: "
				+ "\nNota: 2 || Comentário: Amei, achei digno de Oscar!"
				+ "\n\nComentário com avaliação mais negativa: "
				+ "\nNota: 2 || Comentário: Interessante e inovador. Bastante útil no dia a dia.\n", produtoTeste.getComentarios());
	}

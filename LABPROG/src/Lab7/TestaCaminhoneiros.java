...
package Lab7;
import org.junit.*;
public class TestaCaminhoneiros {
    private Caminhoneiros cam1, cam2, cam3;
    ...
    public void criaObjetos() throws Exception {
        cam1 = new Caminhoneiros("Andecio", "123-4", TONELADAS_ANO_ACIMA_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, VALOR_PADRAO_CARRO, VALOR_PADRAO_CASA);
        cam2 = new Caminhoneiros("Kelvin", "123-5", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS2, NAO_TEM_CARRO, NAO_TEM_CASA);
        cam3 = new Caminhoneiros("Daniel", "123-6", TONELADAS_ANO_ACIMA_TAXA_FIXA, QUILOMETROS_PERCORRIDOS3, VALOR_ACIMA_CARRO, VALOR_ACIMA_CASA);
    }

    @Test
    public void TestaConstrutor() throws Exception {
        try {
            new Caminhoneiros("", "123-4", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, NAO_TEM_CARRO, NAO_TEM_CASA);
        ...
        try {
            new Caminhoneiros("Daniel", "", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, NAO_TEM_CARRO, NAO_TEM_CASA);
            Assert.fail("Deve lançar exceção porque o nome não deve ser uma String vazia.");
        } catch (Exception e) {
            Assert.assertEquals("O nome não pode ser vazio ou null, nem o número de cadastro.", e.getMessage());
        }
        ...
        try {
            new Caminhoneiros("Daniel", null, TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, NAO_TEM_CARRO, NAO_TEM_CASA);
            Assert.fail("Deve lançar exceção porque o nome não deve ser uma String vazia.");
        } catch (Exception e) {
            Assert.assertEquals("O nome não pode ser vazio ou null, nem o número de cadastro.", e.getMessage());
        }
        ...
        try {
            new Caminhoneiros(null, "123-4", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, NAO_TEM_CARRO, NAO_TEM_CASA);
            Assert.fail("Deve lançar exceção porque o nome não deve ser uma String vazia.");
        } catch (Exception e) {
            Assert.assertEquals("O nome não pode ser vazio ou null, nem o número de cadastro.", e.getMessage());
        }
        ...
        try {
            new Caminhoneiros("Daniel", "123-4", -1, QUILOMETROS_PERCORRIDOS, NAO_TEM_CARRO, NAO_TEM_CASA);
        ...
        try {
            new Caminhoneiros("Daniel", "123-4", TONELADAS_ANO_ABAIXO_TAXA_FIXA, -1, NAO_TEM_CARRO, NAO_TEM_CASA);
            Assert.fail("Deve lançar exceção porque o nome não deve ser um número negativo.");
        } catch (Exception e) {
        ...
        try {
            new Caminhoneiros("Daniel", "123-4", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, -1, NAO_TEM_CASA);
            Assert.fail("Deve lançar exceção porque o nome não deve ser um número negativo.");
        } catch (Exception e) {
        ...
        try {
            new Caminhoneiros("Daniel", "123-4", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS, NAO_TEM_CARRO, -1);
            Assert.fail("Deve lançar exceção porque o nome não deve ser um número negativo.");
        } catch (Exception e) {
            Assert.assertEquals("O valor da casa não pode ser negativo.", e.getMessage());
        }
        Assert.assertEquals("Daniel", cam1.getNomeContribuinte());
        ...
        Assert.assertEquals(70000, cam1.getSinaisRiqueza(), 1);
        Assert.assertEquals(3, Caminhoneiros.getNumeroDeCaminhoneiros());
    ...
    public void testaLimiarRiqueza() throws Exception {
        ...
        Assert.assertEquals(535000, Caminhoneiros.getLimiarRiqueza(), 0.01);
        Assert.assertFalse(Caminhoneiros.getCaminhoneiros().get(0).getAcimaDaLimiar());
        Assert.assertFalse(Caminhoneiros.getCaminhoneiros().get(1).getAcimaDaLimiar());
        Assert.assertTrue(Caminhoneiros.getCaminhoneiros().get(2).getAcimaDaLimiar());
    }

    @Test
    public void testaToString() {
        Assert.assertEquals("Nome: Danilo - Número de contribuinte: 123-4", cam1.toString());
        Assert.assertEquals("Nome: Lanmark - Número de contribuinte: 123-5", cam2.toString());
        Assert.assertEquals("Nome: Higor - Número de contribuinte: 123-6", cam3.toString());
    }
    ...
    public void testaEquals() throws Exception {
        ...
        cam1 = new Caminhoneiros("Lanmark", "123-5", TONELADAS_ANO_ABAIXO_TAXA_FIXA, QUILOMETROS_PERCORRIDOS2, NAO_TEM_CARRO, NAO_TEM_CASA);;
